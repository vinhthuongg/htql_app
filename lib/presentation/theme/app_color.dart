...
class AppColor {
  ...
  static const Color attendanceGreen = Color(0xFF00A889);
  static const Color attendanceOrange = Color(0xFFF2A93B);
  static const Color attendanceWarning = Color(0xFFFF6347);
